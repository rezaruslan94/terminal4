...
class PartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post parts_url, params: { part: { name: @part.name, norms: @part.norms, number: @part.number } }
    end
  ...
  test "should update part" do
    patch part_url(@part), params: { part: { name: @part.name, norms: @part.norms, number: @part.number } }
