...
Pic.create(:wh => '5', :qty => '87', :part_id => '1', :area_id => '1', :date => '01-02-2017')
Pic.create(:wh => '12', :qty => '55', :part_id => '2', :area_id => '1', :date => '01-02-2017')
Pic.create(:wh => '51', :qty => '16', :part_id => '3', :area_id => '1', :date => '01-02-2017')
Pic.create(:wh => '32', :qty => '8', :part_id => '4', :area_id => '1', :date => '01-02-2017')
Pic.create(:wh => '15', :qty => '57', :part_id => '5', :area_id => '1', :date => '01-02-2017')
Pic.create(:wh => '56', :qty => '41', :part_id => '1', :area_id => '1', :date => '02-02-2017')
Pic.create(:wh => '85', :qty => '25', :part_id => '2', :area_id => '1', :date => '02-02-2017')
Pic.create(:wh => '5', :qty => '86', :part_id => '3', :area_id => '1', :date => '02-02-2017')
Pic.create(:wh => '2', :qty => '56', :part_id => '1', :area_id => '2', :date => '02-02-2017')
Pic.create(:wh => '41', :qty => '26', :part_id => '2', :area_id => '2', :date => '02-02-2017')
Pic.create(:wh => '23', :qty => '23', :part_id => '3', :area_id => '2', :date => '02-02-2017')
Pic.create(:wh => '46', :qty => '15', :part_id => '4', :area_id => '2', :date => '02-02-2017')
