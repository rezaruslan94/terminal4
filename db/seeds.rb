...
Part.create(:number => 'TLU 1003' :name => 'Bahan Panel Top 2', :norms => '0.025', :item => '1')
Part.create(:number => 'TLU 1002' :name => 'Palang Kaki A', :norms => '0.05', :item => '1')
Part.create(:number => 'TLU 1003' :name => 'Palang Kaki B', :norms => '0.065', :item => '1')
Part.create(:number => 'TLU 1004' :name => 'Palang Kaki C', :norms => '0.015', :item => '1')
Part.create(:number => 'TLU 1005' :name => 'Palang Kaki D', :norms => '0.065', :item => '1')
